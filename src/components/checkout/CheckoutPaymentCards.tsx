...
export function CheckoutSavedCardButton({
  ...
  return (
    <button
      ...
      aria-label={`Saved card ending in ${last4}`}
      className={cn(
  ...
  return (
    ...
    >
      <div className="text-center">
        <p className="text-[13px] font-bold text-ink">New card</p>
        <p className="mt-1 text-[11px] text-ink-60">Enter details below</p>
      </div>
    </button>
  );
}
